//
//  WSTGroupEditDeviceContainerView.m
//  MeshLamp
//
...
@interface WSTGroupEditDeviceContainerView()
@property (nonatomic, strong) UICollectionViewFlowLayout *collectionViewFlowLayout;
@end
@implementation WSTGroupEditDeviceContainerView
...
- (UICollectionView *)collectionView
{
    if (!_collectionView)
    {
        ...
        [_collectionView registerNib:[UINib nibWithNibName:@"WSTGroupDeviceCell" bundle:nil] forCellWithReuseIdentifier:@"WSTGroupDeviceCell"];
