...
@interface WSTCViewController ()<ColorPickerDelegate,WZBlueToothDataSource>
@property (nonatomic,strong) WSTCView  *containerView;

@end

@implementation WSTCViewController
- (void)viewDidLoad {
    [super viewDidLoad];
}
...
- (WSTCView *)containerView{
    if (!_containerView) {
        _containerView = [[WSTCView alloc]init];
