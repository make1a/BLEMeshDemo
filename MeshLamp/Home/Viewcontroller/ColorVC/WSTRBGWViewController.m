//
//  WSTRBGWViewController.m
//  MeshLamp
//
//  Created by 微智电子 on 2017/10/24.
...
@interface WSTRBGWViewController ()<ColorPickerDelegate,WZBlueToothDataSource>
/**Description*/
@property (nonatomic,strong) WSTRGBWView  *containerView;
/**bool */
@end

@implementation WSTRBGWViewController
...
- (WSTRGBWView *)containerView{
    if (!_containerView) {
        _containerView = [[WSTRGBWView alloc]init];
