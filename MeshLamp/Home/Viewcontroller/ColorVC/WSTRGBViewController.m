...
@interface WSTRGBViewController ()<ColorPickerDelegate,WZBlueToothDataSource>
@property (nonatomic,strong) WSTRGBView  *containerView;

@end

@implementation WSTRGBViewController
...
- (WSTRGBView *)containerView{
    if (!_containerView) {
        _containerView = [[WSTRGBView alloc]init];
